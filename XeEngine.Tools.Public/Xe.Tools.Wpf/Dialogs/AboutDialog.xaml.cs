...
namespace Xe.Tools.Wpf.Dialogs
{
	...
	public partial class AboutDialog : Window, INotifyPropertyChanged
	{
		...
		public AboutDialog(Assembly assembly = null)
		{
			...
			version = $"{assemblyName.Version.Major}.{assemblyName.Version.Minor} ({assembly.GetLinkerTime().ToShortDateString()})";
			author = "Luciano (Xeeynamo) Ciccariello";
			powered = "XeEngine Tools Framework";
			authorwebsite = "https://lucianociccariello.com";
